...
(function($) {
   ...
   $(window).load(function() {
	...
	$(".home-slides").vegas({
		...
		delay: 5000,
    	slides: [
       	{ src: "https://api.mapbox.com/styles/v1/mapbox/satellite-v8/static/-123.99,49.559,8.75,0/1280x1014@2x?access_token=pk.eyJ1IjoidGJyb3duIiwiYSI6IlZvempyR3MifQ.UV3klqJHmrE9U6BRB7dENw" },
